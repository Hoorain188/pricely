  ...
  return (
    <div className="max-w-lg mx-auto py-16 px-4 text-center">
      <div className="bg-white border border-[#1D9A7C]/20 rounded-3xl p-8 shadow-xs space-y-4">
        ...
        <h1 className="text-xl font-bold text-slate-900">Saved Wishlist & Favorites</h1>
        ...
        <p className="text-xs text-slate-500 leading-relaxed">
          Save your favorite products from Telemart, Mega.pk, and Daraz to track their price changes in one personal dashboard.
        </p>
